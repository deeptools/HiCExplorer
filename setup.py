...
setup(
    ...
    scripts=['bin/hicFindRestSite', 'bin/hicAggregateContacts', 'bin/hicBuildMatrix', 'bin/hicBuildMatrixMicroC', 'bin/hicCorrectMatrix',
             ...
             'bin/hicTADClassifier', 'bin/hicTrainTADClassifier', 'bin/hicDifferentialLoop'
             ],
