...
setup(
    ...
    scripts=['bin/findRestSite', 'bin/hicAggregateContacts', 'bin/hicPCA',
             'bin/hicBuildMatrix', 'bin/hicCorrectMatrix', 'bin/hicexplorer',
             'bin/hicCorrelate', 'bin/hicFindTADs', 'bin/hicMergeMatrixBins',
             'bin/hicPlotMatrix', 'bin/hicPlotDistVsCounts', 'bin/hicInfo',
             'bin/hicPlotTADs', 'bin/hicSumMatrices', 'bin/hicCompareMatrices',
             'bin/hicTransform', 'bin/hicPlotViewpoint', 'bin/hicQC',
             'bin/hicAdjustMatrix', 'bin/hicNormalize', 'bin/hicConvertFormat',
             'bin/hicAverageRegions', 'bin/hicPlotAverageRegions',
             'bin/hicDetectLoops', 'bin/hicCompartmentsPolarization'
             ],
