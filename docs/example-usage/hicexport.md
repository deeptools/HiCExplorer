# Exporting Hi-C data with hicExport
...
[bioconductor ](http://bioconductor.org/) in R, which allows us to use
...
[diffHic ](https://www.bioconductor.org/packages/release/bioc/html/diffHic.html),
