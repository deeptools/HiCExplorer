...
HiCExplorer has a native interaction matrix format, h5 (an HDF5 container; `.cool`/`.mcool` are also
supported natively and are the recommended format, see below), and several native HDF5 containers for
