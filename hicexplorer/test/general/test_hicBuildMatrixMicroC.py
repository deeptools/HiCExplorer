...
def test_build_matrix(capsys):
    ...
    args = "-s {} {} --outFileName {} -bs 5000 -b {} --QCfolder {} --threads 4".format(sam_R1, sam_R2,
                                                                              ...
                                                                              qc_folder).split()
    # hicBuildMatrixMicroC.main(args)
...
#     outfile.close()
#     qc_folder = mkdtemp(prefix="testQC_")
#     args = "-s {} {} --outFileName {} -bs 5000 -b {} --QCfolder {} --threads 4 --region {}".format(sam_R1, sam_R2,  outfile.name, outfile_bam.name, qc_folder, 'chr3R').split()
#     # hicBuildMatrixMicroC.main(args)
#     compute(hicBuildMatrixMicroC.main, args, 5)
...
#                                                                               outfile.name, outfile_bam.name,
#                                                                               qc_folder, ROOT + 'hicBuildMatrixMicroC/dm3.chrom.sizes', dpnii_file).split()
#     # hicBuildMatrixMicroC.main(args)
#     compute(hicBuildMatrixMicroC.main, args, 5)

#     test = hm.hiCMatrix(ROOT + "hicBuildMatrixMicroC/chromosome_sizes/small_test_chromosome_size.h5")
#     new = hm.hiCMatrix(outfile.name)
#     nt.assert_equal(test.matrix.data, new.matrix.data)
#     nt.assert_equal(test.cut_intervals, new.cut_intervals)
#     # print("MATRIX NAME:", outfile.name)
...
#     # accept delta of 80 kb, file size is around 4.5 MB
#     assert abs(os.path.getsize(ROOT + "hicBuildMatrixMicroC/chromosome_sizes/test.bam") - os.path.getsize(outfile_bam.name)) < delta
...
#     hicInfo.main(args)
#     assert are_files_equal(ROOT + "hicBuildMatrixMicroC/metadata.txt", outfile_metadata.name, delta=7)
...
#     test_5000 = hm.hiCMatrix(ROOT + "hicBuildMatrixMicroC/multi_small_test_matrix.mcool::/resolutions/5000")
#     test_10000 = hm.hiCMatrix(ROOT + "hicBuildMatrixMicroC/multi_small_test_matrix.mcool::/resolutions/10000")
#     test_20000 = hm.hiCMatrix(ROOT + "hicBuildMatrixMicroC/multi_small_test_matrix.mcool::/resolutions/20000")
