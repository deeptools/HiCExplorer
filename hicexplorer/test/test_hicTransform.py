...
def test_hic_transfer_all():
    ...
    # obs_exp
    test = hm.hiCMatrix(ROOT + "hicTransfer/obs_exp_small_50kb.h5")
    new = hm.hiCMatrix(dirname_new + "/obs_exp_" + basename_new)
    nt.assert_equal(test.matrix.data, new.matrix.data)
    os.unlink(dirname_new + "/obs_exp_" + basename_new)

    # pearson
    test = hm.hiCMatrix(ROOT + "hicTransfer/pearson_small_50kb.h5")
    ...
    # covariance
    test = hm.hiCMatrix(ROOT + "hicTransfer/covariance_small_50kb.h5")
...
def test_hic_transfer_pearson():
    ...
    matrix = ROOT + "/hicTransfer/obs_exp_small_50kb.h5"
...
def test_hic_transfer_covariance():
    ...
    outfile.close()
    matrix = ROOT + "/hicTransfer/pearson_small_50kb.h5"
