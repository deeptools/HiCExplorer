...
def main(args=None):
    ...
    for matrix in args.matrices:
        ...
        information.write("# Matrix information file. Created with HiCExplorer's hicInfo version {}\n".format(__version__))
        ...
        if num_non_zero is not None:
            information.write("Non-zero elements:\t{:,}\n".format(num_non_zero))
