...
#                      (1.8*(region_end - region_start)))
    ...
    for idx, properties in enumerate(track_properties):
        ...
        print "time processing {}".format(properties['section_name'])
        start = print_elapsed(start)
    ...
    print "time before saving {}".format(properties['section_name'])
    start = print_elapsed(start)

    plt.savefig(args.outFileName.name, dpi=args.dpi)

    print "time saving {}".format(properties['section_name'])
    start = print_elapsed(start)
